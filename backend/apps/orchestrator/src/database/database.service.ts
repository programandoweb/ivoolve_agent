  ...
  private async migrate(): Promise<void> {
    ...
    const statements = [
      ...
      `CREATE TABLE IF NOT EXISTS argos_sic_outbox (
        ...
        prospect_name VARCHAR(220) NOT NULL,
        payload_json LONGTEXT NOT NULL,
        status VARCHAR(30) NOT NULL DEFAULT 'pending',
        ...
        sic_prospect_id VARCHAR(120) NULL,
        last_error TEXT NULL,
        created_at DATETIME(3) NOT NULL,
        updated_at DATETIME(3) NOT NULL,
        UNIQUE KEY uq_argos_outbox_batch_prospect (batch_id, fingerprint),
        INDEX idx_argos_outbox_due (status, next_attempt_at),
